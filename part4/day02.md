...
def parse_html(html):
	...
	result=hhh.xpath('//*')
	#匹配所有子节点
	result=hhh.xpath('//a/text()')
	#查找div下面的p
	result=hhh.xpath('//div/p/text()')
	#查找元素所有子孙节点
	result=hhh.xpath('//div[@class="channel-item"]')
	#或者条件
	result=hhh.xpath('//div[@class="channel-item"]|//span[@class="pubtime"]/../span/a/text()')
	#父节点
	result=hhh.xpath('//span[@class="article"]//text()')
